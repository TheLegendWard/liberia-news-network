angular.module("liberia_news_network.services", [])
// TODO: --|---- directive
...
.controller ("ShareCtrl", function($rootScope, $scope, $cordovaSocialSharing) {

      $rootScope.shareAnywhere = function($subject, $message,$url_img, $url) {

           $cordovaSocialSharing.share($subject, $message,$url_img, $url);
