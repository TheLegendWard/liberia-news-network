...
/**
 * @author Lincoln Ward <linwilvic@gmail.com>
 * @copyright The Ward Innovation Group 2018
 * @package liberia_news_network
 * 
 * 
...
$config["dbase"] 		= "db_liberia_news_network" ; 		//Database
$config["utf8"] 		= true ; 		//turkish charset set false
$config["abs_url_images"] 		= "http://domain.com/apps/liberia_news_network//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://domain.com/apps/liberia_news_network//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://domain.com/apps/liberia_news_network//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://domain.com/apps/liberia_news_network//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	// TODO: -+- route
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "Liberia News Network" ;
		$rest_api["site"]["description"] = "Get updated news from credible and reliable Liberian news websites." ;
		$rest_api["site"]["imabuilder"] = "rev18.03.28" ;
